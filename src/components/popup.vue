<template>
  <div id="prompt"
    ...
    <div class="clear module-dialog module-dialog-confirm module-dialog-show"
...
export default {
  computed: {
    maxshop () {
      return this.$store.state.maxshop;
    },
  },
  methods: {
    hidCar () {
...
.module-dialog .dialog-close {
  ...
  height: 17px;
  padding: 4px 5px;
  background: url(../img/ui.png) no-repeat -16px -16px;
  text-indent: -9999em;
  opacity: 0.7;
  cursor: pointer;
...
.module-dialog .dialog-btn-wrap {
  ...
  background: url(../img/account-bottom-bar-bg.png) 0 0 repeat-x;
}
.blue-main-btn,
.gray-main-btn,
